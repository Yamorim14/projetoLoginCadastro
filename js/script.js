...
class Validator{
    ...
    equal(input, inputName){
        ...
        let errorMessage = `Este campo precisa estar igual ao campo da senha.`;
    ...
    passwordvalidate(input){
        ...
        if(letgrand === 0 || numeros === 0){
            let errorMessage = `A senha precisa de pelo menos um caracter maiusculo e um número.`;
